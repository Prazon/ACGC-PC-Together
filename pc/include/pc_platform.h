...
/* The PC port has one ABI: native 64-bit pointers. */
...
static_assert(sizeof(void*) == 8, "the PC port requires a 64-bit ABI");
#else
...
_Static_assert(sizeof(void*) == 8, "the PC port requires a 64-bit ABI");
#endif
